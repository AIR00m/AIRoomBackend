...
public class LogAspect {
    ...
    @Pointcut("execution(* com.airoom.airoom..*Controller.*(..)) || execution(* com.airoom.airoom..*Service.*(..)) || " +
            "execution(* com.airoom.airoom..*Repository.*(..)) || execution(* com.airoom.airoom..*Scheduler.*(..))")
